...
public class LoginActivity extends AppCompatActivity {
        ...
        entrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(txt_correo)||TextUtils.isEmpty(txt_password)){
                    Toast.makeText(LoginActivity.this, "Rellen todos lo campos", Toast.LENGTH_SHORT).show();
                }else {
        ...
        mAuth.signInWithEmailAndPassword(Correo,Password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(LoginActivity.this, "Actualice el perfil para mejorar la experiencia", Toast.LENGTH_SHORT).show();
    ...
    public void crear_cuenta(View view) {
        ...
        Intent crearCuenta = new Intent(this,RegistroActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
