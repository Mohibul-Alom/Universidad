        ...
        crear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(txt_usuario)||TextUtils.isEmpty(txt_correo)||TextUtils.isEmpty(txt_password)){
                    Toast.makeText(RegistroActivity.this,"Rellene todos lo campos",Toast.LENGTH_SHORT).show();
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            Toast.makeText(RegistroActivity.this, "Actualice el perfil para mejorar la experiencia", Toast.LENGTH_SHORT).show();
